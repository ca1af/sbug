...
public class CacheNames {
    ...
    public static final String USERDTO = "CACHE_USERDTO";
    public static final String USERDETAILS = "CACHE_USERDETAILS";
    public static final String ALLUSERS = "CACHE_ALLUSERS";
    public static final String THREAD = "CACHE_THREAD";
    public static final String THREADSINCHANNEL = "CACHE_THREADSINCHANNEL";
